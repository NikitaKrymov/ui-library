...
const TagStory: React.FC = () => {
    ...
    const ownClasses = {
        selectContainer: "nk__ui-lib__story__select__overview__container"
    }

    const elementClass = buildClass({
        [classes.overviewBoxContainer]: true,
        [ownClasses.selectContainer]: true
    });
    ...
    return(
        <StoryTemplate>
            ...
            <Accordion title="View code">
                <StoryCodeBox>
{`
<TextArea size="md" label="Text Area" />
`}
                </StoryCodeBox>
            </Accordion>
