...
const InputStory: React.FC = () => {
    ...
    return(
        <StoryTemplate>
            ...
            <StoryViewBox>
                <div className={classes.overviewBoxContainer} style={{ flexDirection: "column", gap: "1rem" }}>
                    <Input size={size} label="Input" />
                    <Input size={size} label="Input" mask="(###)-###-####" maskCharacter="#" />
                </div>
